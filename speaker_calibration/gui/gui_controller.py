...
class SpeakerCalibrationController:
    ...
    def update_hardware(self):
        ...
        self.model.hardware.harp_soundcard = bool(
            self.view.config_frame.hardware_frame.harp_soundcard.get()
        )
        self.model.hardware.soundcard_com = (
            self.view.config_frame.hardware_frame.soundcard_com.get()
        )
        self.model.hardware.soundcard_id = ""
        self.model.hardware.harp_audio_amp = bool(
            self.view.config_frame.hardware_frame.harp_audio_amp.get()
        )
        self.model.hardware.audio_amp_id = ""
        self.model.hardware.speaker_id = (
            self.view.config_frame.hardware_frame.speaker_id.get()
        )
        self.model.hardware.setup_id = (
            self.view.config_frame.hardware_frame.setup_id.get()
        )
